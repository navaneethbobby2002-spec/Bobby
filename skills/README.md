...
| `omni-openhands`       | OpenHands Integration         | Wire OpenHands agent-server to OmniRoute. Generate env/Docker config: model mapping, sandbox privileges, host-gateway, persistence, CORS.                                                       |
